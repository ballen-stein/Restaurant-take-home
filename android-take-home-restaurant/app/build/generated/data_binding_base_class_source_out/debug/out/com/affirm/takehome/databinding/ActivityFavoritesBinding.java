...
public final class ActivityFavoritesBinding implements ViewBinding {
  ...
  private ActivityFavoritesBinding(@NonNull ConstraintLayout rootView, @NonNull Button backButton,
      @NonNull FloatingActionButton fab, @NonNull RecyclerView favoritesList) {
  ...
  public static ActivityFavoritesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.favoritesList;
      RecyclerView favoritesList = rootView.findViewById(id);
      if (favoritesList == null) {
        break missingId;
      }

      return new ActivityFavoritesBinding((ConstraintLayout) rootView, backButton, fab,
          favoritesList);
    }
