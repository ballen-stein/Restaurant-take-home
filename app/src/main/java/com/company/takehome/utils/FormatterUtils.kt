package com.company.takehome.utils
...
fun RestaurantPhoto.createPlacesPhoto(): String {
     ...
     * fixing that first.
     */
    return "https://maps.googleapis.com/maps/api/place/photo?photoreference=${photoReference}&sensor=false&maxheight=${height}&maxwidth=${width}&key=${com.company.takehome.network.places.PlacesRestaurantService.KEY}"
}
//
